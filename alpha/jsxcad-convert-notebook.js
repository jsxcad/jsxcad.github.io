...
<html>
 <head>
  ...
  ${useMermaid ? '<script src="https://cdn.jsdelivr.net/npm/mermaid/dist/mermaid.min.js"></script>' : ''}
 </head>
 <body>
  <script type='module'>
    ...
    const run = async () => {
      ...
      const notebookElement = await toDomElement(await prepareViews(notebook), { useControls: ${useControls ? 'true' : 'false' } });
