import { read, logInfo, write, setupWorkspace, boot, addOnEmitHandler, getNotebookControlData, resolvePending, removeOnEmitHandler } from './jsxcad-sys.js';
...
class Standalone extends ReactDOM.Component {
  static get propTypes() {
    return {
      files: propTypes.exports.object,
      module: propTypes.exports.string,
