...
const wordProblems = [
  ...
  {"problem":"A train travels 120 kilometers in 2 hours. Another train travels 180 kilometers in 3 hours. At what constant speed do both trains travel, in kilometers per hour?","expression":{"equation1":"v = (120 / 2)","equation2":"v = (180 / 3)"},"solution":"v = 60 km/h","prompt":"intercept"},
...
const probabilityProblems = [
  ...
  {"problem":"There are 24 icy treats in a freezer, 12 of which are popsicles. If you randomly select 3 treats from the freezer, what is the probability that at least one of them is a popsicle?","expression":"1 - (21/24)^3","solution":"1 - 9/16 = 7/16","prompt":"frigid"},
  {"problem":"There are 12 red marbles and 8 blue marbles in a jar. If you randomly select 3 marbles from the jar, what is the probability that exactly two of them are red?","expression":"3C2 * 12/20","solution":"3/5","prompt":"earn"},
  ...
  {"problem":"There are 48 marbles in a jar, 24 of which are blue. If you randomly pick 3 marbles from the jar, what is the probability that exactly two of them are blue?","expression":"P(2 blue) = (24C2 * 24C1) / 48C3","solution":"P(2 blue) = (24*23) / (48*47*46) = 13/504","prompt":"unaccountable"},
  ...
  {"problem":"There are 20 students in a class, 8 of whom are rebels. If you randomly choose 3 students, what is the probability that exactly 2 of them are rebels?","expression":"P(2 rebels) = (8C2 * 12C1) / 20C3","solution":"P(2 rebels) = (28*12) / 120 = 336 / 120 = 7 / 10","prompt":"rebel"},
  {"problem":"There are 3 red marbles and 5 blue marbles in a jar. If you randomly select two marbles from the jar, what is the probability that both of them will be red?","expression":"3/8 * 3/8","solution":"9/64","prompt":"interesting"},
  ...
  {"problem":"There are 12 gum drops in a bag, 5 of them are cherry flavored. What is the probability that a randomly selected gum drop from the bag is cherry flavored?","expression":"P(cherry) = 5/12","solution":"The probability of selecting a cherry flavored gum drop is 5 out of 12, or 5/12.","prompt":"chew"},
  ...
  {"problem":"There are 100 students in a class, 60 of whom are healthy. If a student is randomly selected from the class, what is the probability that the student is not healthy?","expression":"P(not healthy) = 1 - (60/100)","solution":"P(not healthy) = 1 - 3/5 = 2/5","prompt":"infirmity"},
  ...
  {"problem":"There are 3 red marbles and 5 blue marbles in a jar. If you randomly pick 2 marbles from the jar, what is the probability that both marbles will be red?","expression":"P(red) * P(red) = (3/8) * (3/8) = 9/64","solution":"The probability of picking a red marble on the first pick is 3/8. The probability of picking a red marble on the second pick is also 3/8. So, the probability of picking both marbles being red is the multiplication of these two probabilities: 9/64.","prompt":"inconvenience"},
  ...
  {"problem":"There are 3 red marbles, 4 blue marbles, and 2 green marbles in a jar. If you randomly select two marbles from the jar without replacement, what is the probability that both marbles will be red?","expression":"3/10 * 3/10","solution":"9/100","prompt":"interference"},
  ...
  {"problem":"There are 40 marbles in a jar, 15 of which are blue. If you reach into the jar and grab a marble without knowing its color, what is the probability that it will be blue?","expression":"P(blue) = 15 / 40 = 3 / 8","solution":"The probability of grabbing a blue marble is 3 in 8 or 3/8.","prompt":"generally"},
  ...
  {"problem":"There are 3 red marbles and 5 blue marbles in a bag. If you randomly select 2 marbles from the bag, what is the probability that both are red?","expression":"P(red and red) = 3/8 * 3/8","solution":"9/64","prompt":"spill"},
  ...
  {"problem":"There are 7 asteroids in a belt, of which 3 are classified as near-Earth asteroids. What is the probability of randomly selecting an asteroid that is not a near-Earth asteroid?","expression":"P(not near-Earth) = 4/7","solution":"The probability of selecting an asteroid that is not a near-Earth asteroid is 4 out of 7, or 4/7.","prompt":"asteroid"},
  {"problem":"There are 4 red marbles and 3 blue marbles in a jar. If you randomly select 2 marbles from the jar, what is the probability that both are red?","expression":"P(red) = 4/7 * 4/7","solution":"16/49","prompt":"retrieval"},
  {"problem":"There are 24 students in a class, and 9 of them are boys. What is the probability that a randomly chosen student is a boy?","expression":"9/24 = 3/8","solution":"The probability of randomly selecting a boy from the class is 3/8.","prompt":"resistance"},
  {"problem":"There are 3 red marbles, 5 blue marbles, and 2 green marbles in a jar. If you randomly pick 2 marbles from the jar, what is the probability that both of them will be red?","expression":"3/10 * 3/10","solution":"9/100","prompt":"truly"},
  ...
  {"problem":"There are 24 cupcakes in a box, 12 of which are chocolate. If you randomly choose 3 cupcakes from the box, what is the probability that exactly 2 of them are chocolate?","expression":"P(2 chocolate) = (12C2 * 12C1) / 24C3","solution":"P(2 chocolate) = (6 * 12) / 120 = 72 / 120 = 3 / 5","prompt":"bless"},
  ...
  {"problem":"There are 3 red marbles and 5 blue marbles in a jar. If you pick two marbles without replacement, what is the probability that both of them will be red?","expression":"3/8 * 3/8","solution":"9/64","prompt":"impending"},
  ...
  {"problem":"There are 30 students in a class, 12 of whom are boys. If a student is randomly selected from the class, what is the probability that the student is a girl?","expression":"P(girl) = (30 - 12) / 30","solution":"P(girl) = 18 / 30 = 3 / 5","prompt":"delinquency"},
  ...
  {"problem":"A jar contains 50 marbles, 25 of which are blue. If you randomly select 3 marbles from the jar, what is the probability that exactly two of them are blue?","expression":"P(2 blue) = 3C2 / 50C3","solution":"P(2 blue) = 3/10","prompt":"excessive"},
  ...
  {"problem":"There are 30 students in a class, 12 of whom are boys. If a student is chosen randomly from the class, what is the probability that the student is a boy?","expression":"P(boy) = 12/30 = 4/15","solution":"The probability of choosing a boy from the class is 4/15.","prompt":"furtive"},
  ...
  {"problem":"There are 12 red marbles and 8 blue marbles in a jar. If you randomly pick 2 marbles from the jar, what is the probability that both are red?","expression":"P(Red and Red) = (12/20) * (12/20)","solution":"P(Red and Red) = 144/400 = 9/25","prompt":"ignite"},
  ...
  {"problem":"There are 12 red marbles and 8 blue marbles in a bag. If you reach in and grab one marble without knowing its color, what is the probability that it will be red?","expression":"P(red) = 12 / (12 + 8)","solution":"P(red) = 12 / 20 = 3 / 5","prompt":"unfurl"},
  ...
  {"problem":"There are 30 students in a class, 12 of whom are boys. What is the probability that a randomly chosen student is a boy?","expression":"P(boy) = 12/30 = 4/15","solution":"The probability that a randomly chosen student is a boy is 4 out of 15, or 4/15.","prompt":"specialist"},
  {"problem":"There are 3 red marbles and 5 blue marbles in a bag. If you randomly choose 2 marbles from the bag, what is the probability that both will be red?","expression":"3/8 * 3/8","solution":"9/64","prompt":"dummy"},
  ...
  {"problem":"There are 3 red marbles and 5 blue marbles in a jar. If you pick two marbles without replacement, what is the probability that both are red?","expression":"3/8 * 2/7","solution":"3/14","prompt":"relational"},
  {"problem":"There are 24 marbles in a jar, 12 of them are blue and the rest are green. If you randomly pick 3 marbles from the jar, what is the probability that exactly two of them are blue?","expression":"P(2 blue and 1 green) = (12/24) * (12/24) * (12/24)","solution":"1/9","prompt":"morally"},
  ...
  {"problem":"There are 12 red marbles and 8 blue marbles in a jar. If you pick one marble without knowing its color, what is the probability that it will be red?","expression":"P(Red) = 12 / (12 + 8)","solution":"P(Red) = 12 / 20 = 3 / 5","prompt":"instant"},
  {"problem":"There are 30 cookies in a jar, 12 of which are chocolate chip. If you randomly choose 5 cookies from the jar, what is the probability that exactly 2 of them are chocolate chip?","expression":"P(2 chocolate chip) = (12/30) * (11/29) * (18/29) * (17/29) * (16/29)","solution":"1320/8748 = 3/7","prompt":"glut"},
  ...
  {"problem":"There are 3 red marbles, 5 blue marbles, and 2 green marbles in a jar. If you randomly pick one marble from the jar, what is the probability that it will be a red or blue marble?","expression":"P(red) + P(blue) = (3/10) + (5/10) = 8/10","solution":"The probability of picking a red or blue marble is 8 out of 10, or 8/10.","prompt":"freely"},
  ...
  {"problem":"There are 3 red marbles and 5 blue marbles in a jar. If you randomly pick 2 marbles from the jar, what is the probability that both marbles are red?","expression":"P(red) = 3/8 * 3/8","solution":"P(red) = 9/64","prompt":"instability"},
  ...
  {"problem":"There are 3 red marbles, 5 blue marbles, and 2 green marbles in a jar. If you randomly select 2 marbles from the jar, what is the probability that both marbles are red?","expression":"P(Red) = 3/10 * 3/10","solution":"P(Red) = 9/100 = 0.09 or 9%.","prompt":"inborn"},
  ...
  {"problem":"There are 3 red marbles and 5 blue marbles in a jar. If you randomly select 2 marbles from the jar, what is the probability that both marbles are red?","expression":"P(Red, Red) = 3/8 * 3/8","solution":"9/64","prompt":"decency"},
  {"problem":"There are 20 pencils in a box, 5 of which are broken. What is the probability that a randomly selected pencil from the box is not broken?","expression":"P(not broken) = 1 - (5/20)","solution":"P(not broken) = 1 - 1/4 = 3/4","prompt":"cumbersome"},
  ...
  {"problem":"There are 12 red marbles and 8 blue marbles in a jar. If you randomly pick 2 marbles from the jar, what is the probability that both are red?","expression":"P(Red) = (12/20) * (12/20)","solution":"P(Red) = 3/5","prompt":"seeker"},
  ...
  {"problem":"There are 24 jokes in a book. 3 of them are puns. What is the probability of randomly selecting a joke that is not a pun?","expression":"P(not pun) = 1 - (3/24)","solution":"P(not pun) = 1 - 1/8 = 7/8","prompt":"humor"},
...
const geometryProblems = [
  ...
  {"problem":"A caddy carries 3 golf bags, each weighing 5 pounds. How many pounds of golf bags does the caddy carry in total?","expression":"3x + 5","solution":"3(5) + 5 = 15 + 5 = 20 pounds","prompt":"caddie"},
  ...
  {"problem":"The area of a circle is represented by πr². If the radius of the circle is increased by 2 cm, how will the area of the circle change?","expression":"π(r+2)^2 - πr^2","solution":"π(r^2 + 4r + 4) - πr^2 = π(4r + 4)","prompt":"accent"},
  {"problem":"A sightseeing tour bus has 50 passengers and wants to allocate 3x seats to adults and 2(x+7) seats to children. How many seats does the bus allocate to adults and children combined?","expression":"3x + 2(x+7)","solution":"3x + 2x + 14 = 5x + 14","prompt":"sightseeing"},
  ...
  {"problem":"A scholar buys notebooks for $2 each and pens for $1.50 each. If she buys x notebooks and y pens, how much did she spend in total?","expression":"2x + 1.50y","solution":"If she buys 5 notebooks and 7 pens, she spent 2(5) + 1.50(7) = $17.50 in total.","prompt":"scholarly"},
...
const copySentences = [
  ...
  {"sentence":"When I was young, I would write like this then.","prompt":"then"},
  {"sentence":"The speaker's voice echoed through the room.","prompt":"speaker"},
  {"sentence":"The tube's smooth curve guided the bouncing ball.","prompt":"tube"},
  {"sentence":"The mayor will inaugurate the new park tomorrow.","prompt":"inaugurate"},
  {"sentence":"The view from the mountain was spectacular!","prompt":"spectacular"},
  {"sentence":"Careful estimation helps avoid overestimating.","prompt":"overestimate"},
  {"sentence":"I solemnly pledge to write clearly and legibly.","prompt":"pledge"},
  {"sentence":"When lines are wrong, slow down and try again.","prompt":"wrong"},
  {"sentence":"A heavy backpack can hamper your writing speed.","prompt":"hamper"},
  {"sentence":"Apathy can be a silent killer of dreams.","prompt":"apathy"},
  {"sentence":"Elaborate handwriting can make your words shine.","prompt":"elaboration"},
  {"sentence":"Hardly had she started when the bell rang.","prompt":"hardly"},
  {"sentence":"An allegory is like a story with hidden meaning.","prompt":"allegory"},
  {"sentence":"Every stroke has the potential to be beautiful.","prompt":"potential"},
  {"sentence":"The cold breeze sent shivers down my spine.","prompt":"shiver"},
  {"sentence":"The *wind* whispered secrets to the leaves.","prompt":"italic"},
  {"sentence":"Jot down your thoughts before they float away.","prompt":"jot"},
  {"sentence":"I am fond of reading stories in the afternoon.","prompt":"fond"},
  {"sentence":"Extra lines make the message redundant.","prompt":"redundant"},
  {"sentence":"The two pencils collided with a soft thud.","prompt":"collide"},
  {"sentence":"Sadly, the rain kept falling on our picnic.","prompt":"sadly"},
  {"sentence":"The focused hunter tracks every detail.","prompt":"hunting"},
  {"sentence":"Fairies dance gracefully in the moonlight.","prompt":"fairy"},
  {"sentence":"The majestic tree's branches reach huge heights.","prompt":"huge"},
  {"sentence":"Deep regret can lead to genuine change.","prompt":"contrition"},
  {"sentence":"A strong start leads to a steady finish.","prompt":"dropout"},
  {"sentence":"A strong charter guides us toward success.","prompt":"charter"},
  {"sentence":"The sleek canoe slices through the calm water.","prompt":"canoe"},
  {"sentence":"The fluffy clouds truly dance in the sky.","prompt":"truly"},
  {"sentence":"The smooth paper felt supple in my hands.","prompt":"supple"},
  {"sentence":"Exploit your potential to write with power!","prompt":"exploit"},
  {"sentence":"A caring hand reaches out to others in need.","prompt":"caring"},
  {"sentence":"Every drawing starts with a basic shape.","prompt":"basis"},
  {"sentence":"Memories are like tiny treasures we keep inside.","prompt":"memory"},
  {"sentence":"The rooster crows loudly in the morning.","prompt":"cock"},
  {"sentence":"The careful grocer checks the fresh produce.","prompt":"grocer"},
  {"sentence":"The spider climbed through the tall grass.","prompt":"through"},
  {"sentence":"Nitrogen makes up most of the air we breathe.","prompt":"nitrogen"},
  {"sentence":"The ocean waves crashed deeply against the shore.","prompt":"deeply"},
  {"sentence":"The babbling brook whispers secrets to the trees.","prompt":"brook"},
  {"sentence":"A hidden stash of treasures in the forest cache.","prompt":"cache"},
  {"sentence":"The little lip on the flower smiled at the sun.","prompt":"lip"},
  {"sentence":"The grumpy cloud bemoaned the lack of sunshine.","prompt":"bemoan"},
  {"sentence":"Inspiration can spark beautiful writing.","prompt":"inspire"},
  {"sentence":"The change was considerably noticeable.","prompt":"considerably"},
  {"sentence":"The careful detector scanned the hidden clues.","prompt":"detector"},
  {"sentence":"Completion brings joy and satisfaction.","prompt":"completion"},
  {"sentence":"A healthy heart is vital for a strong body.","prompt":"vital"},
  {"sentence":"The careful lines in the graveyard guide us home.","prompt":"grave"},
  {"sentence":"Hassling your pen makes your writing messy.","prompt":"hassle"},
  {"sentence":"The tiny atoms split apart, forming new things.","prompt":"fission"},
  {"sentence":"An administrator oversees the school like a boss.","prompt":"administrator"},
  {"sentence":"Saturation makes things less vibrant over time.","prompt":"saturation"},
  {"sentence":"I must admit, my handwriting needs some work.","prompt":"admit"},
  {"sentence":"The big brown boot sat patiently on the ground.","prompt":"boot"},
  {"sentence":"The cozy blanket **inhabits** me like a warm hug.","prompt":"inhabit"},
  {"sentence":"A voter casts their mark to choose our leaders.","prompt":"voter"},
  {"sentence":"A cultivator shapes the ground for growth.","prompt":"cultivator"},
  {"sentence":"Heavenly handprint is what we aim for!","prompt":"hell"},
  {"sentence":"Her graceful movements were truly angelic.","prompt":"angelic"},
  {"sentence":"The water is slowly boiling in the pot.","prompt":"boil"},
  {"sentence":"The flowers looked pretty in the sunshine.","prompt":"pretty"},
  {"sentence":"A graceful verse starts with a perfect line.","prompt":"verse"},
  {"sentence":"Adolescence is a time of growth and change.","prompt":"adolescent"},
  {"sentence":"A contraction combines two words into one.","prompt":"contraction"},
  {"sentence":"The computer defaulted to the old settings.","prompt":"default"},
  {"sentence":"The twentieth letter of the alphabet is T.","prompt":"twentieth"},
  {"sentence":"The cozy cot is perfect for a restful night.","prompt":"cot"},
  {"sentence":"A different way of writing something.","prompt":"variant"},
  {"sentence":"Ugh, that squiggle makes me cringe!","prompt":"cringe"},
  {"sentence":"A goldsmith shapes metal like a sculptor.","prompt":"goldsmith"},
  {"sentence":"The fluffy clouds look really nice today.","prompt":"nice"},
  {"sentence":"Carefully unbutton the colorful shirt.","prompt":"unbutton"},
  {"sentence":"The round knob on the door was easy to grip.","prompt":"knob"},
  {"sentence":"The chief leader grinned confidently.","prompt":"chief"},
  {"sentence":"My secret notebook is completely private.","prompt":"private"},
  {"sentence":"The cozy cottage sits amidst towering trees.","prompt":"cottage"},
  {"sentence":"Like a maverick, I write with my own style.","prompt":"maverick"},
  {"sentence":"A creator's hands write with purpose.","prompt":"creator"},
  {"sentence":"An assistant can lend a helping hand.","prompt":"assistant"},
  {"sentence":"A playful playmate can make any day brighter.","prompt":"playmate"},
  {"sentence":"Cooperation makes our work stronger.","prompt":"cooper"},
  {"sentence":"A strong grip helps words stay connected.","prompt":"dropout"},
  {"sentence":"The fluffy rug feels soft under my feet.","prompt":"rug"},
  {"sentence":"Graceful letters flow like stories on a page.","prompt":"reading"},
  {"sentence":"The tiny stem held a secret garden of dreams.","prompt":"stem"},
  {"sentence":"Every utterance flows like a gentle breeze.","prompt":"utterance"},
  {"sentence":"My voice whispers stories into the wind.","prompt":"voice"},
  {"sentence":"Strong hands can offer support to others.","prompt":"support"},
  {"sentence":"I can rediscover the joy of smooth writing.","prompt":"rediscover"},
  {"sentence":"A pawn moves forward one step at a time.","prompt":"pawn"},
  {"sentence":"Fret not, for practice makes progress.","prompt":"fret"},
  {"sentence":"Every beginner leaves room for growth.","prompt":"beginner"},
  {"sentence":"The tunnel's curves warped the train's path.","prompt":"warp"},
  {"sentence":"A riddle is a mystery waiting to be solved.","prompt":"riddle"},
  {"sentence":"The trumpet's melody danced through the air.","prompt":"trump"},
  {"sentence":"An apology starts with a sincere 'I'm sorry.'","prompt":"apology"},
  {"sentence":"The bidding starts high at the auction today.","prompt":"auction"},
  {"sentence":"The mammoth's tusk was as long as my arm.","prompt":"mammoth"},
  {"sentence":"Sharks have sleek bodies and powerful jaws.","prompt":"shark"},
  {"sentence":"A jockey guides the horse to victory.","prompt":"jockey"},
  {"sentence":"Tortoises move slowly and steadily.","prompt":"tortoise"},
  {"sentence":"A graceful hand deserves a graceful line.","prompt":"deserving"},
  {"sentence":"Deterioration starts with tiny cracks.","prompt":"deteriorate"},
  {"sentence":"A cozy haven provides a peaceful escape.","prompt":"haven"},
  {"sentence":"The warm air gently **heating** the room.","prompt":"heating"},
  {"sentence":"Connecting words helps me relate to others.","prompt":"relate"},
  {"sentence":"The fluffy clouds look thick with rain.","prompt":"thickness"},
  {"sentence":"Every number has a place in arithmetic.","prompt":"arithmetic"},
  {"sentence":"Grabbing groceries makes my tummy happy!","prompt":"grocery"},
  {"sentence":"Preventing mistakes helps us write better.","prompt":"prevention"},
  {"sentence":"The fork tines reach out like tiny hands.","prompt":"fork"},
  {"sentence":"Strong lines and curves make writing robust.","prompt":"robust"},
  {"sentence":"A countryman works hard on his land.","prompt":"countryman"},
  {"sentence":"Make sure to include everyone in the game.","prompt":"include"},
  {"sentence":"The tall wall whispers stories of the past.","prompt":"wall"},
  {"sentence":"Affectionate hearts leave happy trails.","prompt":"affectionate"},
  {"sentence":"To ace a task, I write clearly and neatly.","prompt":"ace"},
  {"sentence":"The pen is driving smoothly across the paper.","prompt":"driving"},
  {"sentence":"Strong ability starts with careful practice.","prompt":"ability"},
  {"sentence":"A sudden break can cause a powerful rupture.","prompt":"rupture"},
  {"sentence":"A telegram is a message sent quickly.","prompt":"telegram"},
  {"sentence":"The cool fizz of Coke bubbles up like magic.","prompt":"coke"},
  {"sentence":"My drawing represents the beauty of nature.","prompt":"represent"},
  {"sentence":"Graceful lines like mountains on a hike.","prompt":"hike"},
  {"sentence":"Gentle strokes create beautiful shapes.","prompt":"gentile"},
  {"sentence":"The final sentence summarizes all the ideas.","prompt":"conclude"},
  {"sentence":"The ancient tree stood profoundly tall.","prompt":"profoundly"},
  {"sentence":"A careless mistake can bring reproach.","prompt":"reproach"},
  {"sentence":"The tiny speaker emitted a clear audio wave.","prompt":"audio"},
  {"sentence":"Every stroke in my business is on point.","prompt":"business"},
  {"sentence":"An activist's words can spark change.","prompt":"activist"},
  {"sentence":"The spinning rotor makes the helicopter fly.","prompt":"rotor"},
  {"sentence":"The tall stool supports the heavy books.","prompt":"stool"},
  {"sentence":"Invalidated pens make writing harder to read.","prompt":"invalidate"},
  {"sentence":"Fifty stars shine brightly in the night sky.","prompt":"fifty"},
  {"sentence":"The swirling snow danced like a silent storm.","prompt":"snowstorm"},
  {"sentence":"I love to enjoy the sunshine on a warm day.","prompt":"enjoy"},
  {"sentence":"Curiosity sparks a fire for learning!","prompt":"curio"},
  {"sentence":"The fluffy clouds are absolutely wonderful!","prompt":"wonderful"},
  {"sentence":"My ancestor's spirit lives on in me.","prompt":"ancestor"},
  {"sentence":"Complacency can be a roadblock to progress.","prompt":"complacency"},
  {"sentence":"Pansy petals unfurl like delicate umbrellas.","prompt":"pansy"},
  {"sentence":"The moonlight was blindingly beautiful.","prompt":"blinding"},
];
...
export const buildCopyProblem = (chosen) => {
  for (;;) {
    ...
    const script = (Math.random() < 0.5) ? 'cursive-script' : 'print-script';
    return Size('CopySentence', 1, `
<span class="${script}">${sentence}</span>
<br/>
